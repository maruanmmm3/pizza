...
class ProductoController extends Controller
{
    public function index(Request $request){
       if($request->user()){
        ...
        $categorias = Categoria::all();
            ...
            return view('productos.index', compact('productos','categorias','total'));
        }
        else{
        $productos = Producto::all();
        $categorias = Categoria::all();
    ...
    function orderNow(Request $request)
    {
        if($request->user()){
            ...
            return view('productos.ordernow',['total' => $total,'productos' => $productos]);
        }

    }
      
    public function addToPedido(Request $request){
        if($request->user()){
